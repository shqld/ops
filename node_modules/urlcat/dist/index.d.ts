export declare type ParamMap = Record<string, any>;
/**
 ...
 * ```
 */
export declare function query(params: ParamMap): string;
/**
 ...
 * ```
 */
export declare function subst(template: string, params: ParamMap): string;
/**
 ...
 * ```
 */
export declare function join(part1: string, separator: string, part2: string): string;
